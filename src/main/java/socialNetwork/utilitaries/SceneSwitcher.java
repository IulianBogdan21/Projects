...
public class SceneSwitcher {
    ...
    private static void defaultSceneOperationForUserViewSwitch(FXMLLoader loader, ActionEvent event, Class sourceClass,
                                       ...
                                       User mainUser, Stage displayStage) throws IOException {
    ...
    private static void defaultSceneOperationForMessageSwitch(FXMLLoader loader, ActionEvent event, Class sourceClass,
        ...
        messageController.setNetworkController(displayStage,networkController,mainUser);
        displayStage.show();
    }
    ...
    public static void switchToUserViewScene(ActionEvent event, Class sourceClass, NetworkController networkController,
        ...
        defaultSceneOperationForUserViewSwitch(loader, event, sourceClass, networkController, mainUser, displayStage);
    }

    public static void switchToFriendshipRequestScene(ActionEvent event, Class sourceClass,
                                                      NetworkController networkController, User mainUser,
        ...
        defaultSceneOperationForFriendshipRequestSwitch(loader, event, sourceClass, networkController, mainUser, displayStage);
    }
    ...
    public static void switchToMessageScene(ActionEvent event, Class sourceClass,
        ...
        defaultSceneOperationForMessageSwitch(loader, event, sourceClass, networkController, mainUser, displayStage);
    }
