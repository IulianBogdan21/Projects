...
public class SceneSwitcher {
    ...
    public static void switchToUserViewScene(ActionEvent event, Class sourceClass, NetworkController networkController,
        ...
        defaultSceneOperationForUserViewSwitch(loader, event, sourceClass, networkController, rootPage, displayStage);
    }

    public static void switchToFriendshipRequestScene(ActionEvent event, Class sourceClass,
                                                      NetworkController networkController, Page rootPage,
        ...
        defaultSceneOperationForFriendshipRequestSwitch(loader, event, sourceClass, networkController, rootPage, displayStage);
    }
    ...
    public static void switchToMessageScene(ActionEvent event, Class sourceClass,
        ...
        defaultSceneOperationForMessageSwitch(loader, event, sourceClass, networkController, rootPage, displayStage);
    }
